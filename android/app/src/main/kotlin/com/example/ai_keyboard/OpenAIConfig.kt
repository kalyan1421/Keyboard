...
class OpenAIConfig private constructor(private val context: Context) {
    ...
    init {
        ...
        Log.d(TAG, "OpenAIConfig initialization complete:")
        Log.d(TAG, "  - API key available: ${finalKey != null}")
        Log.d(TAG, "  - Auth header available: ${authHeader != null}")
        Log.d(TAG, "  - AI features enabled: ${isAIFeaturesEnabled()}")
    }
