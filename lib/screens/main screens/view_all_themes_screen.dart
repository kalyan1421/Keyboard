      ...
      case 'Picture':
        return [
          ThemeItem(
            'Nature',
            'Free',
            _buildNetworkImage('https://picsum.photos/300/200?random=1'),
          ),
          ThemeItem(
            'Abstract',
            'Free',
            _buildNetworkImage('https://picsum.photos/300/200?random=2'),
          ),
          ThemeItem(
            'Space',
            'Free',
            _buildNetworkImage('https://picsum.photos/300/200?random=3'),
          ),
          ThemeItem(
            'Ocean',
            'Free',
            _buildNetworkImage('https://picsum.photos/300/200?random=4'),
          ),
          ThemeItem(
            'Forest',
            'Free',
            _buildNetworkImage('https://picsum.photos/300/200?random=5'),
          ),
          ThemeItem(
            'Mountains',
            'Free',
            _buildNetworkImage('https://picsum.photos/300/200?random=6'),
          ),
          ThemeItem(
            'City',
            'Free',
            _buildNetworkImage('https://picsum.photos/300/200?random=7'),
          ),
          ThemeItem(
            'Desert',
            'Free',
            _buildNetworkImage('https://picsum.photos/300/200?random=8'),
          ),
        ];
      default:
        return [];
